...
- **collect_node.cpp** implements the PDDL action ``(collect ?wp )`` which first moves the manipulator inside the marker, and then moves back it to its home position
